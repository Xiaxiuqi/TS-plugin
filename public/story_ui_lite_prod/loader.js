(() => {
  ...
  const LOADER_FLAG = '__storyRegexUiLoaderReady_lite_prod';
  const LOADER_ENV = 'lite_prod';
  const LOADER_VERSION = 'v2.1';
  ...
  const baseUrl = (() => {
    ...
    const fallback = Array.from(document.scripts)
      ...
      .find(src => src.includes('/story_ui_lite_prod/loader.js'));
