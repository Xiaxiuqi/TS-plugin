      ...
      return `
        ...
        <main class="jjks-manager-body">
          ...
          <section class="jjks-manager-card jjks-manager-map-config jjks-manager-row-full">
            ...
            <p class="jjks-manager-tool-note">只影响数据库地图模块的 AI 地图生成。可选择跟随当前数据库 API，或填写自定义 API 地址、API Key 与模型名称。</p>
            <p class="jjks-manager-tool-note secondary">关闭“启用 AI 地图生成”后，地图模块不会调用 AI；保存设置会保留当前模型，并清除其他模型列表缓存。</p>
