...
console.log('%c[浮岛] 脚本加载中... (v1.1.5 - Release)', 'color: #00ff00; font-weight: bold; font-size: 16px;');
...
function createSettingsUI() {
  try {
    ...
    const $header = $(
      `<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px;"><span style="font-weight:bold;font-size:16px;">浮岛设置 <span style="font-size:10px;font-weight:normal;opacity:0.6;">v1.1.5</span></span><span class="ci-close-btn">${ICONS.close}</span></div>`,
    );
