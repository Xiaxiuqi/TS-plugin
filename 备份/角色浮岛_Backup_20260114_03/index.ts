...
console.log(
  '%c[浮岛] 脚本加载中... (v1.3.0-20260111-170000 - Release)',
...
function createSettingsUI() {
  try {
    ...
    const $header = $(
      `<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px;"><span style="font-weight:bold;font-size:16px;">浮岛设置 <span style="font-size:10px;font-weight:normal;opacity:0.6;">v1.3.0-20260111-170000</span></span><span class="ci-close-btn">${ICONS.close}</span></div>`,
    );
